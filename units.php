    ...
    <div class="product-container" style="margin-left: 10px">
        <table border="1">
            ...
            <tr>
                ...
                <td>
                    <a href="unit-edit.php?unit_id=<?=$value['id'] ?>"> <button type="button" style="background-color: #38b000; width: 100%;">Edit</button> </a>
                    <form method="post" style="margin-top: 2px;">
                        <input type="hidden" name="id" value="<?= $value['id']; ?>">
                        <input style="background-color: #004b23;" type="submit" name="deleteUnit" value="Delete">
                    </form>
                </td>
            </tr>
            <?php endforeach; ?>
